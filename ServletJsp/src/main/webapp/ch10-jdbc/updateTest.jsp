...
%>
		<div class="result-display">
			<div class="align-center">
				성적 수정 완료!<p>
				<input type="button" value="성적 상세" onclick="location.href='detailTest.jsp?id=<%= id %>'">
			</div>
		</div>
<%
	}catch(Exception e){
%>
		<div class="result-display">
			<div class="align-center">
				오류 발생! 성적 수정 실패!<p>
				<input type="button" value="성적 수정 폼" onclick="location.href='updateTestForm.jsp?id=<%= id %>'">
			</div>
		</div>
