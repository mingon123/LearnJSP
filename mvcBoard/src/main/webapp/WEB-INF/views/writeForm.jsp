...
<script type="text/javascript">
	window.onload=function(){
		...
		myForm.onsubmit=function(){
			const items = document.querySelectorAll('input[type="text"],input[type="password"],input[type="email"],textarea'); // 클래스를 주지 않았을 때 그룹선택자로 선택
	...
	<form id="register_form" action="write.do" method="post">
		<ul>
			<li>
				...
				<input type="text" name="title" id="title" size="30" maxlength="50"><!-- size:겉으로 보여지는 크기, maxlength:직접 입력 가능한 최대 글자수 -->
			</li>
			<li>
