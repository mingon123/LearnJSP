...
%>
	<form id="myForm" action="updateTest.jsp" method="post">
		<input type="hidden" name="num" value="<%= num %>"><%-- 화면에 보여지지 않게 하여 사용자가 값을 변경하지 않게 하기 위해 --%>
		<ul>
			<li>
				<label for="name">이름</label>
				<input type="text" name="name" id="name" value="<%= name %>" size="20" maxlength="10"><%-- value는 초기값 미리 보이도록 설정 --%>
			</li>
			<li>
