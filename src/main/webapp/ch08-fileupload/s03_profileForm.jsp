...
<body>
<h2>프로필 사진 업로드하기</h2>
<img id="image" src="../images/face.png" width="200" height="200" alt="Image Preview"><%-- alt : 설명 --%>
<form action="/servletJsp/profile" method="post" enctype="multipart/form-data"><%-- 파일 업로드시 enctype부분 꼭 넣어야 함 --%>
