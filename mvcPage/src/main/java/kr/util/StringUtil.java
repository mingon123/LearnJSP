...
public class StringUtil {
	/*
	제네릭 표현의 ? : 제네릭 자료형을 특정 자료형으로 한정하지 않고 임의의 자료형으로 지정하고자 할 때 ?(와일드카드) 사용
	*/
	// ? : 와일드카드(모든 타입의 자료형 입력할 수 있음)
	public static String parseJSON(HttpServletRequest request,Map<String,?> map) throws JsonGenerationException, JsonMappingException, IOException{ 
		// JSON 데이터 생성
