...
create table zboard_chatroom(
 ...
 constraint chatroom_fk3 foreign key (reader_num) references zmember (mem_num)
);
...
create table zorder(
 ...
 receive_name varchar2(30) not null, --수령인
 receive_post varchar2(5) not null, --수령인의 우편번호
