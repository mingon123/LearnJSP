...
<link rel="stylesheet" href="${pageContext.request.contextPath}/css/layout.css" type="text/css"></head>
<body>
<div class="page-main">
	...
	<div class="content-main">
		...
		<div class="align-center">
			...
			<input type="button" value="배송상태 수정" onclick="location.href='modifyStatusForm.do?order_num=${order.order_num}'">
			</c:if>
