...
<script type="text/javascript">
	$(function(){
		...
		$('#photo').change(function(){
			...
			if(my_photo.size > 1024 * 1024){ // 1M 이상
			...
			$('#photo_submit').click(function(){
				...
				jQuery는 모든 태그를 배열로 인식하기 때문에 [0]을 입력해야만 함
				*/				
				...
				$.ajax({
					...
					data:form_data,
					dataType:'json',
					contentType:false, // 데이터 객체를 문자열로 바꿀지에 대한 값. true면 일반문자 (기본:true)
...
<div class="page-main">
	...
	<div class="content-main">
		...
		<div class="mypage-div">
			...
			<ul>
				<li>
					...
					<c:if test="${!empty member.photo}"><!-- 사진이 입력된 경우 -->
		...
		<div class="mypage-div">
			<h3>내가 쓴 게시물 목록 (채팅) 
			<input type="button" value="더보기" onclick="location.href='${pageContext.request.contextPath}/board/myBoardList.do'"></h3>
			<table>
				<tr>
					<th>제목</th>
					<th>등록일</th>
			...
			<h3>내가 채팅한 게시물 목록
			<input type="button" value="더보기" onclick="location.href='${pageContext.request.contextPath}/board/myChatList.do'"></h3>
			<table>
				<tr>	
					<th>제목</th>
					<th>작성자</th>
