	...
	<div class="content-main">
		...
		<form id="search_form" action="adminList.do" method="get">
			<ul class="search">
				...
				<li>
					<input type="search" size="16" name="keyword" id="keyword" value="${param.keyword}"><!-- 검색할 때 항상 keyfield,keyword를 같이 넘겨야 함 -->
				</li>
				<li>
		...
		<table>
			...
			<tr>
				...
				<td>
					...
					<!-- 숫자로 하면 장점 : 보여지는 값(관리<->관리자)을 바꿔도 실제 값은 변하지 않기 때문에 수정 등에 좋음 -->
				</td>
			</tr>
			</c:forEach>
		</table>
