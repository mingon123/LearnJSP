...
<script type="text/javascript">
	$(function(){
		$('#delete_form').submit(function(){
			const items = document.querySelectorAll('input[type="text"],input[type="email"],input[type="password"]');
		...
		<form action="deleteUser.do" method="post" id="delete_form">
			<ul>
				...
				<li>
					...
					<input type="email" name="email" id="email" maxlength="50" autocomplete="off">
				</li>
				<li>
				...
				<li>
					...
					<input type="password" id="cpasswd" maxlength="12"><!-- name 제거하면 전송안됨 -->
