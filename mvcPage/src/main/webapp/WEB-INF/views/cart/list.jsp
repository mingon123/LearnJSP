			...
			<table>
				...
				<tr>
					...
					<td class="align-center">
						...
						<c:if test="${cart.itemVO.quantity < cart.order_quantity}">[수량부족]<br><small>삭제 후 재고 수량 확인</small></c:if>
					...
					<td class="align-center">
						...
						<br>
						<input type="button" value="삭제" class="cart-del" data-cartnum="${cart.cart_num}" data-itemnum="${cart.item_num}">
					</td>
				</tr>
				</c:forEach>
				<tr>
