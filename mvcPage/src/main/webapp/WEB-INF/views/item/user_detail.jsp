...
<div class="page-main">
	...
	<div class="content-main">
		<c:if test="${item.status == 1}"><!-- 상세페이지는 오래 띄워둘 수 있기 때문에 매번 상태를 확인해야 함 -->
		...
		<c:if test="${item.status == 2}">
			...
			<div class="item-image">
				<img src="${pageContext.request.contextPath}/upload/${item.photo2}" width="400"><!-- photo1은 목록에서 상세에서는 photo2 출력 -->
			</div>
