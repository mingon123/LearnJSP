...
<div class="page-main">
	...
	<div class="contnet-main">
		...
		<hr size="1" noshade width="100%"><!-- noshade="noshade"와 같음 -->
		...
		<ul class="detail-sub">
			...
			<li>
				...
				<c:if test="${user_num != board.mem_num}">
					<input type="button" value="채팅하기" onclick="location.href='chatDetail.do?board_num=${board.board_num}'">
				</c:if>
				
				<%-- 로그인한 회원번호와 작성자 회원번호가 일치해 수정, 삭제 가능 --%>
				<c:if test="${user_num == board.mem_num}"><!-- 인증됨 -->
		...
		<div id="reply_div">
			...
			<form id="re_form">
				...
				><c:if test="${empty user_num}">로그인해야 작성할 수 있습니다.</c:if></textarea><!-- 공백 주의 -->
